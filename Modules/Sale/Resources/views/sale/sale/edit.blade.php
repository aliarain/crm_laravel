                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        if($product_sale->variant_id){
                                                            $product_variant_data = Modules\Sale\Entities\SaleProductVariant::select('id', 'item_code')->FindExactProduct($product_data->id, $product_sale->variant_id)->first();
                                                        ...
                                                        $product_batch_data = Modules\Sale\Entities\SaleProductBatch::select('batch_no', 'expired_date')->find($product_sale->product_batch_id);
                                                    ?>
