                                        ...
                                        <tbody class="tbody">
                                            ...
                                            <?php
                                                        ...
                                                        if($product_quotation->variant_id) {
                                                            $product_variant_data = Modules\Sale\Entities\SaleProductVariant::select('item_code', 'additional_cost')->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)->first();
                                            ...
                                            <tr>
                                                <?php
                                                            ...
                                                            $product_batch_data = Modules\Sale\Entities\SaleProductBatch::select('batch_no', 'expired_date')->find($product_quotation->product_batch_id);
                                                        ?>
