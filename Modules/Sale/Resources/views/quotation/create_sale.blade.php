                                            ...
                                            <tr>
                                                <?php
                                                        ...
                                                        if($product_quotation->variant_id) {
                                                            $product_variant_data = Modules\Sale\Entities\SaleProductVariant::select('item_code')->FindExactProduct($product_quotation->product_id, $product_quotation->variant_id)->first();
                                                        ...
                                                        $product_batch_data = Modules\Sale\Entities\SaleProductBatch::select('batch_no')->find($product_quotation->product_batch_id);
                                                    ?>
