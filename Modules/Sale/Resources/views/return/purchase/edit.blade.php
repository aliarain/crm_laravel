                                                ...
                                                <tr>
                                                    <?php
                                                        ...
                                                        if($product_return->variant_id) {
                                                            $product_variant_data = Modules\Sale\Entities\SaleProductVariant::select('id', 'item_code')->FindExactProduct($product_return->product_id, $product_return->variant_id)->first();
                                                        ...
                                                        $product_batch_data = Modules\Sale\Entities\SaleProductBatch::select('batch_no')->find($product_return->product_batch_id);
                                                    ?>
