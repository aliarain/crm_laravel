                ...
                <div class="card-body">
                    <form action="#" method="POST" id="form_{{ $data['type'] }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="subject" id="subject"
                                        class="form-control ot-form-control ot_input" placeholder="{{ _trans('common.Subject') }}" value=""
                                        required="">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="name">{{ _trans('common.Message') }}<span
                                            class="text-danger">*</span></label>
                                    <textarea placeholder="{{ _trans('common.Your Message') }}" name="message"
                                        class="form-control ot-form-control ot_input" id="message"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    <label class="form-label">{{ _trans('common.Status') }}</label>
                                    <select name="status" id="status" class="form-control ot-form-control select2">
                            ...
                            @if (hasPermission('lead_detail_reminder'))
