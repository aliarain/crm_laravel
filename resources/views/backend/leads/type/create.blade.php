<div class="modal fade type-modal" id="type-modal"  aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content data">
            ...
            <div class="modal-body">
                @if(@$data['show'] != "")
                    <form method="POST" action="{{ route('type.update') }}" class="" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="{{ @$data['show']->id }}">
                @else
                    <form method="POST" action="{{ route('type.store') }}" class="" enctype="multipart/form-data">
                @endif
                        @csrf
                        <div class="row table-content table-basic">
                            ...
                            <div class="col-md-12 col-lg-12 mb-3 ">
                                ...
                                <input type="text" class="form-control ot-form-control ot_input" value="{{ @$data['show']->title }}" name="title"
                            ...
                            <div class="col-md-12 col-lg-12 mb-3 ">
                                ...
                                <input type="number" class="form-control ot-form-control ot_input" value="{{ @$data['show']->order }}" name="order"
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status" class="form-select ot_input">
