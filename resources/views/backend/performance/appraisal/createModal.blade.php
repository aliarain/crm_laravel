                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="title"
                                            class="form-control ot-form-control ot_input" required placeholder=" {{ _trans('common.Title') }}"
                                            value="{{ old('title') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mt-0 ot_input" name="remarks" id="remarks" rows="5" required placeholder="{{ _trans('common.Remarks') }}"></textarea>
                                    </div>
                                </div>
