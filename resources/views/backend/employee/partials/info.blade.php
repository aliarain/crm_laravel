<div class="profile-body p-40 pl-40 pr-40 pt-10">
    ...
    <div class="profile-body-form">
        ...
        <div class="form-group mt-20">
            <label class="mb-10">{{ _trans('profile.Passport File') }}
                @if (@$data['show']->original['data']['passport_file_id'])
                    [<span>
                        <a href="javascript:;" onclick="mainModalOpen(`{{ route('user.fileView', @$data['show']->original['data']['passport_file_id']) }}`) ">
                            <i class="fa fa-eye"></i>
                        </a>
                    </span>]
                @endif
            ...
            {{-- <input type="file" class="form-control ot-form-control ot_input" name="passport_file"> --}}
        ...
        <div class="form-group mt-20">
            <label class="mb-10">{{ _trans('profile.NID File') }}
                @if (@$data['show']->original['data']['nid_file'])
                    [<span>
                        <a href="javascript:;" onclick="mainModalOpen(`{{ route('user.fileView', @$data['show']->original['data']['nid_file']) }}`) ">
                            <i class="fa fa-eye"></i>
                        </a>
                    </span>]
                @endif
            </label>
            {{-- <input type="file" class="form-control ot-form-control ot_input" name="nid_file"> --}}
            <div class="ot_fileUploader left-side mb-3">
                <input class="form-control" type="text" placeholder="{{ _trans('profile.NID File') }}" name="" readonly="" id="placeholder2">
                <button class="primary-btn-small-input" type="button">
        ...
        <div class="form-group mt-20">
            ...
            {{-- <input type="file" class="form-control ot-form-control ot_input" name="avatar"> --}}
            <div class="ot_fileUploader left-side mb-3">
