                    ...
                    <div class="col-md-12">
                        ...
                        @if (@$data['reason'][0] == 'LE')
                            <div class="form-group w-100 mx-auto mb-3">
                                <label
                                    class="form-label float-left">{{ _trans('common.Are You Leaving Early?') }} <span class="text-danger">*</span></label>
                                <textarea type="text" name="reason" id="reason" rows="3" class="form-control ot_input mt-0" required
