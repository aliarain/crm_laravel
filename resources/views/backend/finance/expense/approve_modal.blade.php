                        ...
                        <form action="{{ $data['url'] }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="request_amount" class="form-control ot-form-control ot_input"
                                    value="{{ @$data['expense'] ? $data['expense']->request_amount : old('amount') }}" disabled>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="amount" class="form-control ot-form-control ot_input"
                                    value="{{ @$data['expense']->amount ? $data['expense']->amount : $data['expense']->request_amount }}" required >
                            </div>
                            <div class="form-group mb-3">
                                ...
                                <select name="status" class="form-control modal_select2" required>
                                    <option {{ @$data['expense']->status_id == 2 ? 'selected' : ''}} value="2"> {{ _trans('common.Pending') }} </option>
                                    <option {{ @$data['expense']->status_id == 5 ? 'selected' : ''}} value="5"> {{ _trans('common.Approved') }} </option>
                                    <option {{ @$data['expense']->status_id == 6 ? 'selected' : ''}} value="6"> {{ _trans('common.Rejected') }} </option>
                                </select> 
