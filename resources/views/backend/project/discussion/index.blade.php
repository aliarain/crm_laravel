        ...
        <div class="card-body">
            <div class="panel-body font-size-13">
                ...
                <div id="discussion-comments" class="tc-content jquery-comments">
                            ...
                            <div class="dis-{{ $comment->id }} c-none ml-70 mb-3">
                                ...
                                <div class="form-group float-right d-flex justify-content-end mt-3">
                                    <button class="btn btn-primary"
                                        onclick="commentReply( {{ $comment->id }}, `{{ route('project.discussion.comment', 'project_id=' . $data['view']->id) . '&discussion_id=' . $data['discussion']->id }}`)">{{
                    ...
                    <div class="form-group ">
                        <textarea name="comment-" id="comment-" class="form-control ck_editor mt-0 ot_input" row="5"
                            col="5"> </textarea>
                    </div>
                    <div class="error-message-"></div>
                    <div class="form-group float-right d-flex justify-content-end mt-3">
                        <button class="btn btn-primary"
                            onclick="commentReply(null, `{{ route('project.discussion.comment', 'project_id=' . $data['view']->id) . '&discussion_id=' . $data['discussion']->id }}`)">{{
                            _trans('common.Send') }}</button>
                    </div>
                    @endif
                </div>
