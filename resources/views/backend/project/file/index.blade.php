            ...
            <div class="panel-body font-size-13">
                ...
                <div id="discussion-comments" class="tc-content jquery-comments">
                    <div class="card-body">
                            ...
                            <div class="dis-{{ $comment->id }} c-none ml-70 mb-20">
                                <div class="form-group">
                                    <textarea name="comment-{{ $comment->id }}" id="comment-{{ $comment->id }}"
                                        class="form-control ck_editor ot_input" row="5" col="5"> </textarea>

                                </div>
                                <div class="error-message-{{ $comment->id }}">
                                </div>
                                <div class="form-group float-right d-flex justify-content-end my-4">
                                    <button class="crm_theme_btn "
                                        onclick="commentReply( {{ $comment->id }}, `{{ route('project.file.comment', 'project_id=' . $data['view']->id) . '&file_id=' . $data['file']->id }}` )">{{
                        ...
                        <div class="form-group">
                            <textarea name="comment-" id="comment-" class="form-control ck_editor ot_input " row="5"
                                col="5"> </textarea>
                        </div>
                        <div class="error-message-"></div>
                        <div class="form-group float-right d-flex justify-content-end mt-24">
                            <button class="crm_theme_btn "
                                onclick="commentReply(null, `{{ route('project.file.comment', 'project_id=' . $data['view']->id) . '&file_id=' . $data['file']->id }}` )">{{
                                _trans('common.Send') }}</button>
                        </div>
                        @endif
                    </div>
